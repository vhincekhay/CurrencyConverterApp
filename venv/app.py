...
app = Flask(__name__, template_folder="/Users/nanakhay/UMGC-SUMMER2023/CMSC495/PYTHON CODE/my_currency_converter/templates")
...
class RealTimeCurrencyConverter():
    ...
    @staticmethod
    def run(url):
        # Start the currency converter with the provided URL
        return RealTimeCurrencyConverter(url)

    def restart(self, url):
        # Restart the currency converter with the provided URL
        self.update_converter(url)
